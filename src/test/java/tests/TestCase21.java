...
public class TestCase21 extends TestBasic {
    ...
    public void addReviewOnProduct() throws IOException, ParseException, java.text.ParseException {
    ...
    private void verifySuccessMessageThankYouForYourReview() throws IOException, ParseException, java.text.ParseException {
