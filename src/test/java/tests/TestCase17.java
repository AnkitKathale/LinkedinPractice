...
public class TestCase17 extends TestBasic{
    ...
    private void verifyThatProductIsRemovedFromTheCart() {
        String emptyCart = new CartPage(getDriver())
        .xButtonClick()
        .getEmptyCartSpan()
        .getText();

        Assert.assertEquals(emptyCart, "Cart is empty! Click here to buy products.","Verify that product is removed from the cart");
    }
