...
public class TestCase14 extends TestBasic{
    ...
    public void placeOrderRegisterWhileCheckout() throws IOException, java.text.ParseException, ParseException {
    ...
    public static void verifyAccountCreatedAndClickContinueButton(String name, String email) throws IOException,java.text.ParseException {
    ...
    public static void verifyAddressDetailsAndReviewYourOrder() throws IOException, ParseException, java.text.ParseException {
    ...
    public static void verifyAddressDetails() throws IOException, ParseException, java.text.ParseException {
    ...
    public static void verifySuccessMessageCongratulationsYourOrderHasBeenConfirmed() throws IOException, ParseException, java.text.ParseException {
