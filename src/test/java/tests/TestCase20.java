...
public class TestCase20 extends TestBasic {
    ...
    public void searchProductsAndVerifyCartAfterLogin() throws IOException, ParseException, InterruptedException, java.text.ParseException {
        TestCase8.verifyUserIsNavigatedToAllProductsPageSuccessfully();
        TestCase9.verifySearchedProductsIsVisible();
        List<String> productsNames = TestCase9.verifySearchedProductsIsVisible();
