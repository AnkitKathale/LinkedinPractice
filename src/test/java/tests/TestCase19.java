...
public class TestCase19 extends TestBasic{
    ...
    public void viewCartBrandProducts() throws IOException, ParseException, java.text.ParseException {
    ...
    private void verifyThatUserIsNavigatedToBrandPageAndBrandProductsAreDisplayed() throws IOException, ParseException, java.text.ParseException {
    ...
    private void verifyThatUserIsNavigatedToThatBrandPageAndCanSeeProducts() throws IOException, ParseException, java.text.ParseException {
        String titleTextCenter = new ProductsPage(getDriver())
                .madameBrandClick()
                .getTitleTextCenter()
                .getText();
